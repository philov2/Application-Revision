                        ...
                        <>
                          ...
                          {nouveauChapitreMatiereId === m.id ? (
                            <form onSubmit={(e) => creerNouveauChapitreAdmin(e, m.id)} className="flex items-center gap-1.5 pt-1">
                              ...
                              <button type="submit" disabled={enCoursChapitreAdmin || !nomNouveauChapitreAdmin.trim()} className="rounded-lg px-2 py-1 text-xs font-medium text-white disabled:opacity-50" style={{ background: "#4169E1" }}>
                            ...
                            <button type="button" onClick={() => setNouveauChapitreMatiereId(m.id)} className="text-xs font-medium hover:underline pt-1" style={{ color: "#4169E1" }}>
                              + Nouveau chapitre
                            </button>
                          )}
                        </>
