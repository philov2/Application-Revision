...
export function calculerStatsDevoirs(devoirs, aujourdHui = new Date()) {
  ...
  if (d.echeance === todayStr) {
    ...
    return { aFaireAujourdhui, enRetard, realisesDansLesDelais, retardPlusUneSemaine, totalAFaire };
}
...
// devoirs faits plus anciennement disparaissent de la liste affichee.
